<x-app-layout>
  <body>
    ...
    <!-- ========== JUMBROTON ========== -->
    <section class="bg-center bg-no-repeat bg-cover bg-gray-400 bg-blend-multiply" style="background-image: url({{asset('storage/img/produksi.jpg')}})">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-28">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">P  R  O  D  U  K  S  I</h1>
