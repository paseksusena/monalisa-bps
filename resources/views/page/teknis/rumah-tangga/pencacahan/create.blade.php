<!-- form create untuk pencacahan -->
<form id="hs-sign-out-alert3" method="POST" action="/teknis/kegiatan/rumah-tangga/pencacahan"
        ...
        <div
            ...
            <div class="p-4 overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <!-- input tanggal nks -->
                    <div class="mb-5">
                        <label for="nks" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NKS
                        </label>
