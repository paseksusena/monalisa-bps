    ...
    <div class="flex items-center justify-center min-h-screen">
        <div
            ...
            <div class="relative bg-white shadow-xl rounded-2xl dark:bg-blue-800">
                ...
                <!-- form untuk menambahkan excel -->

                <form class="flex flex-col space-y-4 p-4 overflow-y-auto"
                    action="/teknis/rumah-tangga/pemutakhiran/create-excel" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <!-- inputan untuk mengirimkan kegiatan_id -->
