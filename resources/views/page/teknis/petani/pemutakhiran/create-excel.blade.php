<!--Modal create excel pemutakhiran-->
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div
            ...
            <div class="relative bg-white shadow-xl rounded-2xl dark:bg-blue-800">
                ...
                <!--Form create excel pemutakhiran-->
                <form class="flex flex-col space-y-4 p-4 overflow-y-auto"
                    action="/teknis/kegiatan/petani/pemutakhiran-create-excel" method="POST"
                ...
                <!--End Form create excel pemutakhiran-->
            </div>
        </div>
    </div>
</div>
<!--End Modal create excel pemutakhiran-->
<!--script mengambil tanggal awal dan tanggal akhir untuk read only-->
<script>
    function openCreatePetaniExcel(button) {
        const id = button.getAttribute('data-id');
        console.log(button);
        fetch(`/teknis/kegiatan/petani/pemutakhiran-create/${id}`) //Url mengambil data
            .then(response => {
                if (!response.ok) {
    ...
    //fucntion untuk menampilkan nama file sebelum di submit
