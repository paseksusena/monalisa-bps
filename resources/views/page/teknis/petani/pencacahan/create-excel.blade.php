    ...
    <div class="flex items-center justify-center min-h-screen">
        <div
            ...
            <div class="relative bg-white shadow-xl rounded-2xl dark:bg-blue-800">
                ...
                <!--Form create excel pencacahan-->
                <form class="flex flex-col space-y-4 p-4 overflow-y-auto"
                    action="/teknis/kegiatan/petani/pencacahan-create-excel" method="POST"
                ...
                <!--End Form create excel pencacahan-->
            </div>
        </div>
    </div>
</div>
<!--End Modal create excel pencacahan-->
<!-- handling error -->
@if ($errors->any())
...
<script>
    ...
    // function untuk menampilkan nama file sebelum di submit
