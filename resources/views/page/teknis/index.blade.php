                                ...
                                <div class="bg-blue-500 text-white px-2 py-1 rounded-bl-lg">
                                    ...
                                    <div class="hs-dropdown relative inline-flex z-50">
                                        ...
                                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-30 bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                                            aria-labelledby="hs-dropdown-default">
                                            <button data-id="{{$kegiatan->id}}" data-hs-overlay="#hs-focus-management-modal2" onclick="openEditModal(this)" class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-base text-blue-600 hover:bg-gray-200 focus:outline-none focus:bg-gray-100 dark:text-blue-400 dark:hover:bg-blue-700 dark:hover:text-blue-300 dark:focus:bg-blue-700">
                                                Edit
                                            </button>
                                            <form id="delete-kegiatan-{{$kegiatan->id}}" action="/teknis/kegiatan/{{ $kegiatan->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')

                                                <input type="hidden" value="{{$kegiatan->id}}" name="kegiatan">
                                                <!-- Tambahkan input hidden untuk mengirimkan data yang diperlukan -->
                                                <button onclick="confirmDelete({{$kegiatan->id}})" type="button" class="flex items-center gap-x-3.5 py-1 px-3 rounded-lg text-base text-red-600 hover:bg-gray-200 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700">
                                                    Delete
                                                </button>
                                            </form>
                                        </div>
