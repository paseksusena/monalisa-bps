<!-- Modal crate excel pencacahan -->
<div id="hs-sign-out-alert3"
        ...
        <div
            ...
            <div class="relative bg-white shadow-xl rounded-2xl dark:bg-blue-800">
                ...
                <form class="flex flex-col space-y-4 p-4 overflow-y-auto"
                    action="/teknis/perusahaan/pencacahan/create-excel" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- input hidden Id  -->
                                ...
                                <div class="flex flex-col items-center justify-center w-full">
                                    <div
                                        ...
                                        <span id="file-name" class="mb-2">Drag and drop your file here or click to
                                            upload</span>
                                        <!-- input file excel dan menampilkan nama file  -->
                ...
                <!-- End Forn create excel  -->
            </div>
        </div>
    </div>
</div>

<!-- script agar ketika ada data lebih dari satu tanggal awal dan akhir bersifat read only  -->
<script>
    function openCreatePerusahaanExcel(button) {
        const id = button.getAttribute('data-id');

        fetch(`/teknis/kegiatan/perusahaan/pencacahan-create/${id}`) //url mengambil data
            .then(response => {
                if (!response.ok) {
    ...
    //function untuk menampilkan nama file excel sebelum klik tombol simpan
