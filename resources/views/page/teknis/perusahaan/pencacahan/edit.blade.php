<div id="hs-sign-out-alert6" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
...
<script>
    function openEditModal(button) {
        ...
        fetch(`/teknis/perusahaan-pencacahan-edit/${id}`)
            .then(response => {
                if (!response.ok) {
