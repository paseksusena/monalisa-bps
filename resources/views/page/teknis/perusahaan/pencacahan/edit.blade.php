     ...
     <div
         ...
         <div
             ...
             <div class="px-4 pb-4 overflow-y-auto">
                 ...
                 <form action="/teknis/kegiatan/perusahaan/pencacahan/update" method="POST" class="space-y-4">
                     @method('PUT')
                     @csrf
                     <!--Inputan hidden Id  -->
                     ...
                     <div class="mb-5">
                         <label for="kode_desa-edit"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Desa</label>
                     ...
                     <div class="mb-5">
                         <label for="kode_sbr-edit"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode SBR</label>
 ...
 <!--  script untuk mengambil value edit dari setiap Id inputan -->
 <script>
     function openEditModal(button) {
         const id = button.getAttribute('data-id');
         fetch(`/teknis/perusahaan-pencacahan-edit/${id}`) //Url mengambil data edit
             .then(response => {
                 if (!response.ok) {
             ...
             .then(data => {
                 ...
                 //Ambil data ketika ada setiap Id inputan
                 if (data != 0) {
                     document.getElementById('id-edit').value = data.id; //Edit Id
                     ...
                     document.getElementById('tgl_awal-edit').setAttribute('readonly',
                         true); // Set the readonly attribute
                     document.getElementById('tgl_akhir-edit').setAttribute('readonly',
                         true); // Set the readonly attribute
                 } else {
                     document.getElementById('tgl_awal-edit').removeAttribute(
                         'readonly'); // Remove the readonly attribute
                     document.getElementById('akhir-edit').tglAkhir.removeAttribute(
                         'readonly'); // Remove the readonly attribute
                 }
                 // Populate form fields with the fetched data

                 // Open the edit form overlay
                 const editForm = document.getElementById('hs-sign-out-alert6');
