    ...
    <div
        ...
        <div id="basic-tabs-1" role="tabpanel" aria-labelledby="basic-tabs-item-1">
            <div class="grid lg:grid-cols-1 gap-1 bg-gray-100 shadow-lg p-4 rounded-lg overflow-x-auto mb-10">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-center">
                            ...
                            <button type="button" data-id="{{ $kegiatan->id }}"
                                onclick="openCreatePerusahaanExcel(this)"
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 rounded-lg dark:divide-gray-700">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($pencacahans as $pencacahan)
                                                ...
                                                <tr
                                                    ...
                                                    <td class="px-6 py-3 flex justify-center items-center space-x-2">
                                                        <a class="text-blue-600 hover:underline">
                                                            <button type="button"
                                                                data-hs-overlay="#hs-sign-out-alert6"
                                                        ...
                                                        @include('page.teknis.perusahaan.pencacahan.edit')

                                                        <form id="delete-pencacahan-perusahaan{{ $pencacahan->id }}"
                                                            action="/teknis/kegiatan/perusahaan/pencacahan/{{ $pencacahan->id }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                                ...
                                                <!-- End perulangan data yang ada di table -->
                                            @endforeach
                                        </tbody>
                                    </table>
                                </div>
                ...
                <!-- mengamil halaman blade Data excel-->
                @include('page.teknis.perusahaan.pencacahan.create-excel')

                <!--  Mengambil halaman blade Data Manual-->
                @include('page.teknis.perusahaan.pencacahan.create')
...
<script>
    function confirmDelete(id) { //mengambil Id untuk alert konfirmasi hapus pada setiap data
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.getElementById('delete-pencacahan-perusahaan' + id).submit();
            }
        });
    }
    ...
    @endif
    //function untuk mengirimkan data asinkronus pada checklist verifikasi
    $(document).ready(function() {
        $('.link-checkbox').on('change', function() {
            ...
            $.ajax({
                url: `/teknis/kegiatan/perusahaan/pencacahan/ceklist/${id}`, //Url mengirimkan data asinkronus pada checklist
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
