                                            ...
                                            <tr
                                                ...
                                                <td
                                                 ...
                                                 <td class="px-7 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                    ...
                                                    <div class="flex items-center">
                                                        <input type="hidden" value="{{$pencacahan->id}}" name="id" class="ceklist_id">
                                                ...
                                                <td class="px-6 py-3 flex justify-center items-center space-x-2">
                                                    <a class="text-blue-600 hover:underline">
                                                        <button type="button" data-hs-overlay="#hs-sign-out-alert6" data-id="{{$pencacahan->id}}" onclick="openEditModal(this)"
                                                    ...
                                                    <form id="delete-pencacahan-perusahaan{{$pencacahan->id}}" action="/teknis/kegiatan/perusahaan/pencacahan/{{$pencacahan->id}}" method="POST">
                                                        @csrf
                                                        @method('delete')
