        ...
        <div
            ...
            <div class="p-4 overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <div class="mb-5">
                        <label for="pml" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            PML</label>
                    ...
                    <div class="mb-5">
                        <label for="ppl" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            PPL</label>
...
<!--script untuk set tanggal awal dan tanggal akhir menjadi read only ketika ada data masuk minimal 1 -->
<script>
    function openCreatePerusahaan(button) {
        const id = button.getAttribute('data-id'); //Url untuk mengambil data
