  <!-- Modal crate excel pemutakhiran -->
          ...
          <div
              ...
              <div class="relative bg-white shadow-xl rounded-2xl dark:bg-blue-800">
                  ...
                  <form class="flex flex-col space-y-4 p-4 overflow-y-auto"
                      action="/teknis/perusahaan/pemutakhiran/create-excel" method="POST"
  ...
  <script>
      function openCreatePerusahaanExcel(button) {
          ...
          fetch(`/teknis/perusahaan-pemutakhiran-create/${id}`) //url mengambil data
              .then(response => {
                  if (!response.ok) {
