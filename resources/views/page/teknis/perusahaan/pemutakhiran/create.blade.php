...
<form id="hs-sign-out-alert1" method="POST" action="/teknis/kegiatan/perusahaan/pemutakhiran" 
        ...
        <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <div class="p-4 overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <div class="mb-5">
                        <label for="pml" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PML</label>
                    ...
                    <div class="mb-5">
                        <label for="ppl" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PPL</label>
