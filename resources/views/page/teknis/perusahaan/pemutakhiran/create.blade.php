<!--Form untuk create pemutakhiran -->
        ...
        <div
            ...
            <div class="p-4 overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <div class="mb-5 mt-5">
                        <label for="kode_sbr" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode
                            SBR</label>
...
<script>
    function openCreatePerusahaan(button) {
        ...
        fetch(`/teknis/perusahaan-pemutakhiran-create/${id}`) //Url untuk menngambil data
            .then(response => {
                if (!response.ok) {
