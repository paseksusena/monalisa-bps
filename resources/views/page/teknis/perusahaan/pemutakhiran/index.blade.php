                                            ...
                                            @foreach ($pemutakhirans as $pemutakhiran)
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        ...
                                                        @if ($pemutakhiran->status == 0)
                                                            <div class="flex items-center">
                                                                <input type="hidden" value="{{ $pemutakhiran->id }}"
                                                    ...
                                                    <td class="px-6 py-3 flex justify-center items-center space-x-2">
                                                        ...
                                                        <form
                                                            id="delete-pemutakhiran-perusahaan{{ $pemutakhiran->id }}"
                                                            action="/teknis/kegiatan/perusahaan/pemutakhiran/{{ $pemutakhiran->id }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
...
<script>
    ...
    $(document).ready(function() {
        $('.link-checkbox').on('change', function() {
            ...
            $.ajax({
                url: `/teknis/kegiatan/perusahaan/pemutakhiran/ceklist/${id}`, //Url mengirimkan data asinkronus pada checklist
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
