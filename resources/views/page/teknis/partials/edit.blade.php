        ...
        <div
            ...
            <div class="p-4 overflow-y-auto">
                <form id="edit-form" action="/teknis/kegiatan" method="POST">
                    ...
                    <label for="dropdown-edit" class="block text-sm font-medium mt-4 mb-2 dark:text-white">Pilih Kategori Kegiatan</label>
