      ...
      <div class="w-full flex items-center justify-end ms-auto sm:justify-between sm:gap-x-3 sm:order-3">
        ...
        <div class="hidden sm:block">
            ...
            <div class="relative min-w-72 md:min-w-80">
                <form action="/administrasi/periode" class="flex">
                    <input type="hidden" name="fungsi" value="{{ $fungsi }}">
                    <input type="text" id="search" name="search" value="{{request('search')}}" class="py-2 px-4 block w-full border-gray-200 rounded-l-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Search Periode" required>
