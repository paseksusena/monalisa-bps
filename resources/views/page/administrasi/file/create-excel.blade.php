...
<!-- Form create excel -->
<form action="/administrasi/file/store_excel" method="POST" enctype="multipart/form-data">
    @csrf
                        ...
                        <label class="block w-full">
                            ...
                            <div class="flex flex-col items-center justify-center w-full">
                                <div
                                    ...
                                    <span class="mb-2" id="file-name">Drag and drop your file here or click to
                                        upload</span>
                                    <!-- Inputan untuk menambahkan file excel serta nampilkan file excel -->
...
<!-- End form create excel -->

<!-- script untuk menampilkan nama file excel -->
<script>
