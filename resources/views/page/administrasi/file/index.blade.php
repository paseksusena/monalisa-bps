...
<body>
    ...
    <div class="w-full  lg:ps-64">
        <div class="p-4 sm:p-6 space-y-4 sm:space-y- mb-10">
            ...
            <!-- Menngabil halamam blade dari create pdf -->
            @include('page.administrasi.file.create-pdf')

            <!-- mengambil halam blade dari create excel -->
            ...
            <!-- script mengirmkan value ajax pada (ceklist) -->
            <script>
                $(document).ready(function() {
                    $('.link-checkbox').on('change', function() { //function checklist
                        const id = $(this).siblings('.ceklist_id').val();
                        const isChecked = $(this).prop('checked');
                        console.log(isChecked);
                        $.ajax({
                            url: `/administrasi/file/ceklist/${id}`, //route url mengirimkan checklist
                            type: 'POST', //method
                            data: {
                                _token: '{{ csrf_token() }}',
                                isChecked: isChecked
                ...
                //filter
                $(document).ready(function() {
                    $('.filter-option').on('click', function(e) { //function filter pada status
                        e.preventDefault();
                        //mengambil data Id pada status
                        ...
                        // Mengambil parameter status dalam Url ini
                    ...
                    $('.filter-option-ceklist').on('click', function(e) { //function filter pada verifikasi atau checklist
                        e.preventDefault();
                        //mengambil data Id pada checklist
                        ...
                        // Mengambil parameter checklist dalam Url ini
                        let url = '/administrasi/file?transaksi=' + transaksi + '&akun=' + akun + '&kegiatan=' +
                            kegiatan + '&fungsi=' + fungsi + '&status=' + status + '&ceklist=' +
                            ceklist;
                        // script Ajax
                ...
                //script sweet alert untuk menghapus data pada setiap Id
                function confirmDelete(id) { //mengambil Id dan konfirmasi hapus
                    Swal.fire({
                ...
                // script untuk memvalidasi apakah itu file ekstensi PDF
