    ...
    <div class="w-full  lg:ps-64">
        <div class="p-4 sm:p-6 space-y-4 sm:space-y- mb-10">
            ...
            <div class="iflex justify-between items-center w-full">
                <!-- Container tombol tambah kegiatan dan import kegiatan -->
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                            ...
                                            <div class="px-1 py-3 text-start">
                                                <div class="flex items-center gap-x-3">
                                                    <span
                                                        ...
                                                        <!-- proses mengirimkan request untuk sorting bagian nama kegiatan -->
                                                        <a href="{{ request()->fullUrlWithQuery(['order-nama' => request('order-nama') === 'asc' ? 'desc' : 'asc', 'order-progres' => null]) }}"
                                                            ...
                                                            Nama Kegiatan @if (request('order-nama') === 'asc')
                                    ...
                                    @foreach ($kegiatans as $kegiatanAdministrasi => $kgtn)
                                        <!-- perulangan data tabel kegiatan -->
                                        <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-1 py-3 text-start">
                                                    <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="px-3 py-3 text-start">
                                                        <div class="flex items-center gap-x-3">
                                                            <span
                                                                class="text-sm font-extrabold text-gray-800 dark:text-neutral-200 ml-2 mr-8">
                                                                <a
                                                                    href="/administrasi/akun?kegiatan={{ $kgtn->id }}&fungsi={{ $fungsi }}">
                                                                    {{ $kgtn->nama }}</a>
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-3 py-1.5 flex space-x-2">
                                                    <form id="delete-form-{{ $kgtn->id }}"
                                                        action="/administrasi/kegiatan/{{ $kgtn->id }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <input type="hidden" value="{{ $fungsi }}"
                                                            name="fungsi">
                                                        <input type="hidden" value="{{ $kgtn->id }}"
                                                            name="kegiatan">
                                                        <button type="button"
                                                    ...
                                                    <a href="#" class="text-blue-600 hover:underline">
                                                        <button type="button" data-hs-overlay="#edit-kegiatan"
                                                            data-id="{{ $kgtn->id }}"
                                                    ...
                                                    <!-- mengambil halaman blade dari edit kegiatan -->
                                                    @include('page.administrasi.kegiatan.edit')
                                                </div>
                                            </td>
                                        </tr>
                                        <!-- End perulangan data tabel kegiatan -->
                                    @endforeach
                                </tbody>
                            </table>
