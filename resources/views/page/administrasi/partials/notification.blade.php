...
<div class="hs-dropdown relative inline-flex ml-2 mr-4">
    <div class="rounded-lg bg-gray-100 p-1">
        <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
            ...
            type="button">
            <svg class="w-6 h-6 text-amber-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 14 20">
                <path
                    d="M12.133 10.632v-1.8A5.406 5.406 0 0 0 7.979 3.57.946.946 0 0 0 8 3.464V1.1a1 1 0 0 0-2 0v2.364a.946.946 0 0 0 .021.106 5.406 5.406 0 0 0-4.154 5.262v1.8C1.867 13.018 0 13.614 0 14.807 0 15.4 0 16 .538 16h12.924C14 16 14 15.4 14 14.807c0-1.193-1.867-1.789-1.867-4.175ZM3.823 17a3.453 3.453 0 0 0 6.354 0H3.823Z" />
            </svg>
            <div data-hs-bullet=""
                class="hidden absolute  w-3 h-3 bg-red-600 border-2 border-white rounded-full -top-0.5 start-2.5 dark:border-gray-900">
            </div>
        </button>
    </div>
</div>
...
<div id="dropdownNotification"
    ...
    <div
        ...
        <!-- Tombol download notifikasi excel -->
        <a href="/download-notifinasi-excel"
...
<script>
    $(document).ready(function() {
        $.ajax({
            url: '/notifications', // Url notifikasi
            type: 'GET',
            success: function(response) {
                ...
                //perulanngan data notifikasi selama ada data (value)
                ...
                //kondisi jika variabel > 0 maka tampilkan
