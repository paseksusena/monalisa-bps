 <!-- menangani error ketika ada error -->
 @if (session('error'))
     ...
     <div
         ...
         <form action="/administrasi/akun" method="POST"
             ...
             <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                 <h3 class="font-bold text-gray-800 dark:text-white">Edit Nama Akun</h3>
                 <!-- Tombol x (close) -->
                 <button type="button"
             ...
             <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-gray-700">
                 <button type="button"
                     ...
                     data-hs-overlay="#edit-akun">Batal</button>
                 <button type="submit"
 ...
 <!-- script mengambil data sebelumnya untuk di edit -->
 <script>
     function openEditModal(button) {
         const id = button.getAttribute('data-id');
         fetch(`/administrasi/akun/${id}`) //mengambil data Id dari route url
             .then(response => {
                 if (!response.ok) {
             ...
             .then(data => {
                 ...
                 //untuk mengetahui id editId dan editName
                 if (editId && editName) {
                 ...
                 //mengambil element id dari edit akun
                 document.getElementById('edit-akun').classList.remove('hidden');
             })
             .catch(error => {
