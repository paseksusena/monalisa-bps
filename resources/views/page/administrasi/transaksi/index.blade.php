                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                    ...
                                    <td class="size-px whitespace-nowrap"> 
                                        <div class="px-1 py-3 text-start flex items-center gap-x-3">
                                            <span class="text-sm font-medium text-gray-800 dark:text-neutral-200">
                                                {{ \Carbon\Carbon::parse($trans->tgl_akhir)->format('d/m/Y') }}
                                            </span>
                                            @if (\Carbon\Carbon::now()->gt(\Carbon\Carbon::parse($trans->tgl_akhir )) && $trans->progres < 100)
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 13, 13, 1);">
                                                <path d="m17.284 3.707 1.412-1.416 3.01 3-1.413 1.417zm-10.586 0-2.99 2.999L2.29 5.294l2.99-3zM12 4c-4.879 0-9 4.121-9 9s4.121 9 9 9 9-4.121 9-9-4.121-9-9-9zm1 14h-2v-2h2v2zm0-4h-2V8h2v6z"></path>
                                            </svg>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-3 py-1.5 flex space-x-2">
                                            ...
                                            <a href="#" class="text-blue-600 hover:underline">
                                                <button type="button" data-hs-overlay="#edit-transaksi" data-id="{{ $trans->id }}" onclick="openEditModal(this)"
