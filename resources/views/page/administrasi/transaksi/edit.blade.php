...
<div
    ...
    <form action="/administrasi/transaksi" method="POST"
        ...
        <div class="flex flex-col space-y-4 p-4 overflow-y-auto">
            <!-- Nama Kegiatan -->
            <div>
                <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama Transaksi</label>
                <input type="text" id="edit-nama" name="nama" value="{{ old('nama') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
                @error('nama')
    ...
    <div>
        ...
        <input type="text" id="edit-no_kwt" name="no_kwt" value="{{ old('no_kwt') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
        @error('no_kwt')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
    ...
    <div>
        ...
        <input type="date" id="edit-tgl_akhir" name="tgl_akhir" value="{{ old('tgl_akhir') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
        @error('tgl_akhir')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
    ...
    <div>
        ...
        <input type="text" id="edit-bln_arsip" name="bln_arsip" value="{{ old('bln_arsip') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
        @error('bln_arsip')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
