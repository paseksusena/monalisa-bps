              ...
              <div class="flex flex-col space-y-4 p-4 overflow-y-auto">
                  ...
                  <div>
                      <label for="nilai_trans"
                          class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nilai
                          Transaksi</label>
                  ...
                  <div>
                      <label for="bln_arsip"
                          class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Bulan
                          Pengarsipan</label>
  ...
  <!-- Script untuk menampilkan data yang akan di edit -->
  <script>
      function openEditModal(button) {
          const id = button.getAttribute('data-id');
          fetch(`/administrasi/transaksi/${id}`) //mengambil data edit sebelumnya dari route Url
              .then(response => {
                  if (!response.ok) {
      ...
      //mengkonversi nilai transaksi menjadi format Rupiah
