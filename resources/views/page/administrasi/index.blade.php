    ...
    @else
        ...
        <div class="w-full lg:ps-64 flex justify-center items-center h-screen">
            <div class="text-center">
                ...
                <h1 class="text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl font-medium text-gray-700">Selamat
                    Datang
                    Di Halaman Administrasi</h1>
                <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-3xl font-bold text-gray-700">Monalisa
                </h1>
            </div>
        </div>
    @endif
