<div id="hs-toggle-between-modals-pencacahan-rumah-tangga"
            ...
            <div class="px-4 overflow-y-auto">
                <div class="space-y-4">
                    <form method="POST" action="/mitra-pencacahan-rumah-tangga">
                        ...
                        <input type="hidden" id="kegiatan-id" name="kegiatan_id">
...
<script>
    function openInputModalRumahTangga(button) {
        const id = button.getAttribute('data-id');
        const kegiatanID = document.getElementById('kegiatan-id');
        ...
        fetch(`/mitra/rumah-tangga/pencacahan-input/${id}`)
            ...
            .then(data => {
                if (data !== 0) {
                    kegiatanID.value = data.kegiatan_id;
                    idPencacahan.value = data.id;
