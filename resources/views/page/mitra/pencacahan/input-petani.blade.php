<div id="hs-toggle-between-modals-input-petani">
    <form action="/teknis/kegiatan/petani/pencacahan" method="POST"
            ...
            <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="space-y-4">
                        ...
                        <div class="mb-5">
                            <label for="tgl_akhir-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tanggal Selesai</label>
                            <input type="date" id="tgl_akhir-edit-petani" name="tgl_akhir"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="kode_kec-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Kode Kecamatan</label>
                            <input type="text" id="kode_kec-edit-petani" name="kode_kec"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="kecamatan-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Kecamatan</label>
                            <input type="text" id="kecamatan-edit-petani" name="kecamatan"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="kode_desa-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Kode Desa</label>
                            <input type="text" id="kode_desa-edit-petani" name="kode_desa"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="desa-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Desa</label>
                            <input type="text" id="desa-edit-petani" name="desa"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="id_pml-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">ID PML</label>
                            <input type="text" id="id_pml-edit-petani" name="id_pml"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="pml-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama PML</label>
                            <input type="text" id="pml-edit-petani" name="pml"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="id_ppl-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">ID PPL</label>
                            <input type="text" id="id_ppl-edit-petani" name="id_ppl"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="ppl-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama PPL</label>
                            <input type="text" id="ppl-edit-petani" name="ppl"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="nks-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">NKS</label>
                            <input type="text" id="nks-edit-petani" name="nks"  readonly
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="jenis_komoditas-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jenis Komoditas</label>
                            <input type="text" id="jenis_komoditas-edit-petani" name="jenis_komoditas"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>

                        <div class="mb-5">
                            <label for="nama_krt-edit-petani" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama KRT</label>
...
<script>
    function openInputModalPetani(button) {
        ...
        fetch(`/teknis/kegiatan/petani/pencacahan-edit/${id}`)
            .then(response => {
                if (!response.ok) {
