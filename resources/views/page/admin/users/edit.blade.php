...
<div id="hs-focus-management-modaleditadmin" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
      ...
      <div class="p-4 overflow-y-auto">
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
          ...
          @method('PUT')
          <div class="p-4 overflow-y-auto">
              <label for="role" class="block text-sm font-medium mb-2 ml-1 dark:text-white">Role</label>
              <select name="role" id="role" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:placeholder-neutral-500 dark:text-neutral-400">
                  ...
                  <option value="anorganik" {{ $user->role === 'anorganik' ? 'selected' : '' }}>Anorganik</option>
              </select>
          </div>
