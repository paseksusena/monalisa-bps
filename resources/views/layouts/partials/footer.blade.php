    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div class="mt-2 grid space-y-3">
                <p><a class="inline-flex gap-x-2 text-gray-800 hover:text-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/teknis/kegiatan?fungsi=Umum">Umum</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-800 hover:text-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/teknis/kegiatan?fungsi=Produksi">Produksi</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-800 hover:text-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/teknis/kegiatan?fungsi=Distribusi">Distribusi</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-800 hover:text-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/teknis/kegiatan?fungsi=Neraca">Neraca</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-800 hover:text-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/teknis/kegiatan?fungsi=Sosial">Sosial</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-800 hover:text-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            ...
            <div class="col-span-1">
                ...
                <h2
                    ...
                    Sosial Media</h2>
                <div>
                    <a class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-700 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                        href="https://www.facebook.com/bpskabupatenbuleleng">
                    ...
                    <a class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-700 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                        href="https://www.instagram.com/bpskabbuleleng?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">
                        <svg fill="#374151" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg"
                            stroke="#374151">
                    ...
                    <a class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-700 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                        href="https://bulelengkab.bps.go.id">
                    ...
                    <a class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-gray-700 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                        href="https://youtube.com/@bpskabupatenbuleleng8249?si=oLXFRVWIallZA8Es">
